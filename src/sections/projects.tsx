...
const ProjectsShowcase = () => {
    const projects = [
        {
            title: "Digipin",
            description: "Search for the DIGIPIN for your location. This app demonstrates how to use the Digital Postal Index Number (DIGIPIN) by the Department of Posts in India, aiming to simplify geo-coded addressing for public and private services.",
        ...
        },
        {
            ...
            description: "Developed at Camptocamp with help from Ismail Sunni, this plugin allows QGIS users to easily browse and add resources from the QGIS Hub directly into their projects. It supports grid and list views, search, and filtering by resource type.",
            tech: ["Python", "Qt", "QGIS"],
        ...
        },
        {
            ...
            description: "Developed at Camptocamp as part of my internship, this project helps to benchmark the performance of WebGL and Canvas rendering in Openlayers. It includes a variety of tests and visualizations to compare the rendering speed of different layers.",
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {projects.map((project) => (
                    ...
                    <div className="relative mb-4 overflow-hidden rounded-lg">
                        ...
                        <h3 className="text-2xl font-bold mb-2 transform">
                            {project.title}
                        </h3>
