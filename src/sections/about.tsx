...
export default function About() {
    const cards: InfoCardProps[] = [
        {
            title: "About Me",
            description: "I'm currently working as a Geospatial Software Engineer at Camptocamp, where I specialize in geospatial software development.",
            imageSrc: Character1,
            imageAlt: "Character1",
        ...
        },
        {
            ...
            description: "I thrive on continuously learning various geospatial technologies, from GIS software to spatial databases, to shape ideas into functional applications.",
            imageSrc: Character2,
            imageAlt: "Character2",
            bgColor: "bg-white dark:bg-secondaryBlack",
        ...
        {
            title: "Other Hobbies",
            description: "Here are some of my other passions: I like to dance, play chess, love watching F1, and am a Potterhead.",
            imageSrc: Character4,
            imageAlt: "Character4",
            bgColor: "bg-white dark:bg-secondaryBlack",
            imagePosition: "left" as const
